...
const  About=()=> {
  return (
    <div className="relative isolate bg-white px-6 py-10 md:py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-2 text-balance text-xl md:text-2xl  tracking-tight text-black sm:text-2xl paragraph">
        Hi, I am Talha, a recent graduate with a BS in Software Engineering from Lahore Garrison University.
        </p>
      </div>
 
      <div className="mx-auto mt-10 md:mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
